...
public class PathUtil {
  public static PathPlannerPath getPath(String name) {
    try {
      ...
      e.printStackTrace();
      return new PathPlannerPath(PathPlannerPath.waypointsFromPoses(Pose2d.kZero, Pose2d.kZero, Pose2d.kZero), PathConstraints.unlimitedConstraints(12), new IdealStartingState(0.0, Rotation2d.kZero), new GoalEndState(0.0, Rotation2d.kZero));
    }
  }
