...
public class HubShiftUtil {
  ...
  private static void setLEDState() {
    if (DriverStation.isDisabled()) {
      lights.setSolidColor(Color.Bright.GREEN, Segment.All);
    } else {
      if (shootingToStart(5) || shootingToStop(5)) {
        lights.setStrobeAnimation(Color.Bright.GREEN, Segment.All, 400);
      } else if (shootingToStart(10) || shootingToStop(10)) {
        lights.setStrobeAnimation(Color.Bright.GREEN, Segment.All, 250);
      } else if (shootingToStart(15) || shootingToStop(15)) {
        lights.setStrobeAnimation(Color.Bright.GREEN, Segment.All, 100);
      } else {
        lights.setSolidColor(Color.Bright.GREEN, Segment.All);
      }
    }
